...
const TaskCard = ({ taskId, isDragging }: TaskCardProps) => {
  const { data: task, isLoading, error } = useGetTaskById(taskId, true);
  ...
  return (
    ...
    >
      {isDragging && (
        <div className="absolute inset-0 z-10 bg-gray-200 opacity-100" />
      )}
